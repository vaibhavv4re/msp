        ...
        <div className="min-h-screen bg-gray-50 p-12">
            <div className="max-w-2xl mx-auto bg-white rounded-[3rem] shadow-2xl border border-gray-100 overflow-hidden ring-1 ring-gray-200/50">
                <div className="p-12 border-b flex justify-between items-start bg-gray-50/50">
                    <div>
                        <h1 className="text-4xl font-[1000] text-gray-900 uppercase tracking-tight">Add Expense</h1>
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mt-1">Registering a new outgoing</p>
                    </div>
                </div>
                <div className="p-12">
                    {form}
