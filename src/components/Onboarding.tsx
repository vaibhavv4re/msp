...
export function Onboarding({ userId, onComplete }: { userId: string; onComplete: () => void }) {
    ...
    return (
        <div className="fixed inset-0 bg-white z-[200] flex flex-col md:flex-row animate-in fade-in duration-700 overflow-y-auto">
            ...
            <div className="flex-1 bg-black text-white p-12 flex flex-col justify-between min-h-[400px]">
                <div>
                    <div className="flex items-center gap-1 mb-16">
                        <span className="text-4xl font-[1000] leading-none">B</span>
                        <span className="text-4xl font-[1000] text-blue-500 leading-none -ml-1">.</span>
                    </div>
                    <div className="space-y-6">
                        <span className="text-[10px] font-black text-blue-400 uppercase tracking-[0.4em] block">Welcome to the future</span>
                        <h1 className="text-5xl md:text-7xl font-[1000] uppercase tracking-tighter leading-[0.9]">
                            Define Your <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-gray-500">Business.</span>
                        </h1>
                        <p className="text-gray-400 text-sm font-bold uppercase tracking-widest max-w-md leading-relaxed">
                            Let's craft your professional identity. Setting up your first business profile takes less than 60 seconds.
                        </p>
                    </div>
                </div>

                <div className="grid grid-cols-2 gap-8 py-8 border-t border-white/10 mt-12">
                    <div className="space-y-2">
                        <Palette className="w-6 h-6 text-blue-400" />
                        <p className="text-[10px] font-black uppercase tracking-widest text-white">Custom Branding</p>
                    </div>
                    <div className="space-y-2">
                        <Calculator className="w-6 h-6 text-blue-400" />
                        <p className="text-[10px] font-black uppercase tracking-widest text-white">Tax Compliance</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 bg-gray-50 p-12 flex items-center justify-center">
                <div className="max-w-md w-full space-y-12 text-center md:text-left">
                    <div className="space-y-4">
                        <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tighter">Choose your start</h2>
                    ...
                    <div className="space-y-4">
                        <button
                            onClick={() => setShowModal(true)}
                            className="w-full group bg-white p-8 rounded-[3rem] shadow-sm border border-gray-100 flex items-center gap-6 hover:shadow-2xl hover:border-blue-100 hover:-translate-y-1 transition-all"
                        >
                            ...
                            <div className="text-left flex-1">
                                <p className="text-[11px] font-black text-blue-600 uppercase tracking-widest mb-1">Recommended</p>
                                <h4 className="text-lg font-[1000] text-gray-900 uppercase tracking-tight">Create First Profile</h4>
                            </div>
                        ...
                        <button
                            ...
                            className="w-full group bg-white/50 p-6 rounded-[2.5rem] border border-gray-100 flex items-center gap-6 hover:bg-white hover:shadow-xl transition-all"
                        >
                            <div className="w-12 h-12 bg-gray-200 rounded-xl flex items-center justify-center shrink-0">
                                <Briefcase className="w-5 h-5 text-gray-500" />
                            </div>
                            <div className="text-left flex-1">
                                <h4 className="text-sm font-black text-gray-500 group-hover:text-gray-900 uppercase tracking-widest transition-colors">Skip for now</h4>
                            </div>
                        </button>
                    </div>

                    <div className="pt-8 text-center text-[9px] font-black text-gray-400 uppercase tracking-[0.3em]">
